...
k = 1:1:N;
figure;
plot(k,X_real(3,:),'b',k,X_esti_A(3,:),':g','linewidth',LineWidth);
legend('实际状态3','FCDKF估计状态3','Location','best');

figure;
plot(k,X_real(2,:),'b',k,X_esti_A(2,:),':g','linewidth',LineWidth);
legend('实际状态2','FCDKF估计状态2','Location','best');

figure;
plot(k,X_real(1,:),'b',k,X_esti_A(1,:),':g','linewidth',LineWidth);
legend('实际状态1','FCDKF估计状态1','Location','best');
...
%  X_esti_AFCDKF_r = r_esti_A;
% 
% save AFCDKF_MIMO_NonDiff_X_real X_real
% save AFCDKF_MIMO_NonDiff_X_esti_AFCDKF  X_esti_AFCDKF
% save AFCDKF_MIMO_NonDiff_X_esti_AFCDKF_r X_esti_AFCDKF_r
% save AFCDKF_MIMO_NonDiff_r_real r_real
