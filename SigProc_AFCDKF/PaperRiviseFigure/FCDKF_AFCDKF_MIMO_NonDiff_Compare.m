...
%卡尔曼滤波
        %状态预测:X_pre
        diff_X_esti = [cos(X_esti_B(2,k-1)); ...
              -0.1*X_esti_B(2,k-1) + exp(-0.05*X_esti_B(3,k-1)) + U_input(1,k-1); ...
        ...
        temp_f_plus_hs1 = [cos( X_esti_B(2,k-1)+ h_con*S_chol(2,1) ); ...
               -0.1*( X_esti_B(2,k-1)+h_con*S_chol(1,1) ) + ...
               exp( -0.05*(X_esti_B(3,k-1)+h_con*S_chol(3,1)) )+U_input(1,k-1); ...
               -(X_esti_B(3,k-1)+h_con*S_chol(3,1))- ...
               0.5*abs( X_esti_B(1,k-1)+h_con*S_chol(1,1) )];
                           
        temp_f_subtraction_hs1 = [cos( X_esti_B(2,k-1)- h_con*S_chol(2,1) ); ...
               -0.1*( X_esti_B(2,k-1)-h_con*S_chol(1,1) )+ ...
               exp( -0.05*(X_esti_B(3,k-1)-h_con*S_chol(3,1)) )+U_input(1,k-1); ...
               -(X_esti_B(3,k-1)-h_con*S_chol(3,1))- ...
               0.5*abs( X_esti_B(1,k-1)-h_con*S_chol(1,1) )];

        temp_f_plus_hs2 = [cos(X_esti_B(2,k-1)+ h_con*S_chol(2,2)); ...
                            -0.1*(X_esti_B(2,k-1)+h_con*S_chol(1,2))+ ...
               exp( -0.05*(X_esti_B(3,k-1)+h_con*S_chol(3,2)) )+U_input(1,k-1); ...
               -(X_esti_B(3,k-1)+h_con*S_chol(3,2))- ...
               0.5*abs( X_esti_B(1,k-1)+h_con*S_chol(1,2) )];
           
        temp_f_subtraction_hs2 = [cos( X_esti_B(2,k-1)- h_con*S_chol(2,2) ); ...
                            -0.1*( X_esti_B(2,k-1)-h_con*S_chol(1,2) ) + ...
               exp( -0.05*(X_esti_B(3,k-1)-h_con*S_chol(3,2)) )+U_input(1,k-1); ...
               -(X_esti_B(3,k-1)-h_con*S_chol(3,2))- ...
               0.5*abs( X_esti_B(1,k-1)-h_con*S_chol(1,2) )];  
                       
        temp_f_plus_hs3 = [cos(X_esti_B(2,k-1)+ h_con*S_chol(2,3)); ...
            -0.1*(X_esti_B(2,k-1)+h_con*S_chol(1,3))+ ...
            exp( -0.05*(X_esti_B(3,k-1)+h_con*S_chol(3,3)) )+U_input(1,k-1); ...
            -(X_esti_B(3,k-1)+h_con*S_chol(3,3))- ...
            0.5*abs( X_esti_B(1,k-1)+h_con*S_chol(1,3) )];
        
        temp_f_subtraction_hs3 = [cos( X_esti_B(2,k-1)- h_con*S_chol(2,3) ); ...
            -0.1*( X_esti_B(2,k-1)-h_con*S_chol(1,3) ) + ...
            exp( -0.05*(X_esti_B(3,k-1)-h_con*S_chol(3,3)) )+U_input(1,k-1); ...
            -(X_esti_B(3,k-1)-h_con*S_chol(3,3)) - ...
            0.5*abs( X_esti_B(1,k-1)-h_con*S_chol(1,3) )];  
        ...
        %测量值估计  Z_esti ---- Z_k|k-1
        Z_esti = 0.1*X_pre(1,1) + 0.3*X_pre(2,1) + r_test;%
        ...
        %状态更新
        X_esti_B(:,k) = X_pre + Kk*( Z_meas(1,k) - Z_esti );
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %估计方差矩阵更新
        P_esti_B{1,k} = P_pred - Kk*P_zpred*Kk';
...
legend('实际状态3','AFCDKF估计状态3','FCDKF估计状态3','Location','best');

figure;
plot(k,X_real(2,:),'b',k,X_esti_A(2,:),'--r',k,X_esti_B(2,:),':g','linewidth',LineWidth);
legend('实际状态2','AFCDKF估计状态2','FCDKF估计状态2','Location','best');

figure;
plot(k,X_real(1,:),'b',k,X_esti_A(1,:),'--r',k,X_esti_B(1,:),':g','linewidth',LineWidth);
legend('实际状态1','AFCDKF估计状态1','FCDKF估计状态1','Location','best');
%line([Outliers Outliers],[-3 5])

figure;
plot(k,r_esti_A,'b','linewidth',LineWidth);
legend('均值估计','Location','best');
line([0 N],[r r])


% X_esti_AFCDKF = X_esti_A;
% X_esti_FCDKF  = X_esti_B;
% r_esti = r_esti_A;
% r_real = r;
% 
...
%  FCDKF_AFCDKF_MIMO_NonDiff_Compare
